...
**Your Answers here:**
<br> https://github.com/7kfpun/awesome-fintech
<br>
...
**Your Answers here:**
<br> Answer 1: This is at the beginning: `mytickers = c("SPY", "AAPL")`, which tells R to download data relating to both S&P 500 and Apple together. I used DataSet1.R
<br>Answer 2: 
1. Apple's cumulative returns are `r round(100*sum(StockReturns[,"AAPL"]),1)`%.
2. Apple's average daily returns of the Apple index during this period is `r round(100*mean(StockReturns[,"AAPL"]),3)`%
3. Apple's standard deviation is `r round(100*sd(StockReturns[,"AAPL"]),2)`%;
<br>
<br>Answer 3: change myTickers = c("YHOO") and run anaysis as before.
...
**Your Answers here:**
<br>Answer 1: change startDate to "2001-01-01"
<br>
<br>
<br>
...
<br>Answer 1: 20
<br>
<br> Extra Exercise Answer: I received the following error message: 'Error in FUN(left, right) : non-numeric argument to binary operator.' This is because the tables values are not aligned.
