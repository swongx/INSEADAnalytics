...
4. Can you now generate the principal components and scree plot using only: 
...
1) I will need 6 components to explain 50% of the variance.

2) 
<br> 5 yr T-Notes US	0.93																			
<br> 10yr T-Notes	0.93																			
<br> Treasury Bonds	0.86																			
<br> 2 yr T-Note US	0.85																			
<br> Canadian Bond	0.79																			
<br> Eurodollar	0.74

<br> 3) Component 1: Goverment notes and bonds
Component 2: Currencies
Component 3: Non-US Stock exchanges
Component 4: US Stock exchanges
Component 5: EUro-cross exchange
Component 6: Crude oil and others
Component 7: Hard metals
Component 8: Soft commodities
Component 9: Precious metals
Component 10: Asian Stock Indexes 

<br>4a) Precrisis data:
...
print(Line, 'chart')
```
5) Assests are more correlated during the crisis period. This can be impled from the fact that 15 components have an eigenvalue of  more than 1 and account for 69.95% of cumulative explained variance during the precrisis period compared to 13 pricinple components that account for 75.4% of cumulative explained variance during the crisis period.
...
1) The code is using the result of the moving day averages (from 10 to 250 days over a window of 20 days) to assign whether it is positive or negative and then allocates a dollar to each asset such that they sum up to $1 everyday.

2) Using different technical indicators will result in a different returns 
